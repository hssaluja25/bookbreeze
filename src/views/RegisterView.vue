        ...
        <div class="bg-indigo-50 min-h-screen">
            <div
                ...
                <div
                    ...
                    <button :disabled="disable_submission" @click="registerWithGoogle()" aria-label="Continue with google"
                        role="button"
              ...
              <p class="text-base font-medium ml-4 text-gray-700">Continue with Github</p>
                    ...
                    <vee-form @submit="createWithEmail">
                        ...
                        <div>
                            ...
                            <vee-field :rules="'required|min:5|max:100|email'" name="email" id="email"
                        ...
                        <div class="mt-6 w-full">
                            ...
                            <div class="relative flex items-center justify-center">
                                <vee-field :rules="{
                                    ...
                                    max: 100,
                                    regex: /^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[!@#\$%\^&\*])(?=.{8,})/
                                }" name="password" id="myInput" :type="showPassword ? 'password' : 'text'"
                                ...
                                <div class="absolute right-0 mt-2 mr-3 cursor-pointer">
                                    ...
                                    <div @click="showPassword = true" v-if="showPassword === false" class="">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-eye-off"
                                            width="16" height="16" viewBox="0 0 24 24" stroke-width="1.5" stroke="#27272A"
                        ...
                        <div class="mt-6 w-full">
                            ...
                            <div class="relative flex items-center justify-center">
                                <vee-field :rules="'confirmed:@password'" name="confirm" id="myConfirmPassword"
                                ...
                                <div class="absolute right-0 mt-2 mr-3 cursor-pointer">
                                    ...
                                    <div @click="showConfirmPassword = true" v-if="showConfirmPassword === false" class="">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-eye-off"
                                            width="16" height="16" viewBox="0 0 24 24" stroke-width="1.5" stroke="#27272A"
                                            fill="none" stroke-linecap="round" stroke-linejoin="round">
                                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                ...
                <div class="xl:w-1/3 md:w-1/2 lg:ml-16 ml-8 md:mt-0 mt-6">
                    <div class="flex items-start mt-8">
                        ...
                        <p class="sm:text-2xl text-xl leading-7 text-gray-600 pl-2.5">
                            Unlock a world of knowledge with our library management app. Sign up or log in to explore and
                            buy your favorite books today!
                        </p>
                    </div>
                </div>
            </div>
